...
describe('public FlowGuard website PoC positioning', () => {
  ...
  test('authenticated route definitions and private page imports remain present', () => {
    ...
    ['/dashboard', '/enrollment', '/cameras', '/object-detection', '/vpatrol', '/gate-scanner', '/attendance', '/users', '/security-review', '/incidents', '/incidents/analytics', '/support-dashboard'].forEach((route) => {
